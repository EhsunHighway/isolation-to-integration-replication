...
SOURCE_FILE="tcas.c"
DRIVER_FILE="test_Non_Crossing_Biased_Climb.c"
REQUIRED_FILES="ALIM.c Inhibit_Biased_Climb_stub.c Non_Crossing_Biased_Climb.c Own_Above_Threat_stub.c Own_Below_Threat_stub.c initialize.c"
INCLUDE_FOLDER="."
TARGET_FUNCTION="Non_Crossing_Biased_Climb"
