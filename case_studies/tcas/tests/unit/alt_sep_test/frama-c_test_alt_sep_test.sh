...
REQUIRED_FILES="Non_Crossing_Biased_Climb_stub.c Non_Crossing_Biased_Descend_stub.c Own_Above_Threat_stub.c Own_Below_Threat_stub.c alt_sep_test.c initialize.c"
INCLUDE_FOLDER="."
