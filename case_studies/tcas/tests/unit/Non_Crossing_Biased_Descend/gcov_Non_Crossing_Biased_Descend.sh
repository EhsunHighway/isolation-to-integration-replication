...
TEST_EXECUTABLE="test_Non_Crossing_Biased_Descend"
SOURCE_FILES="Non_Crossing_Biased_Descend.c ALIM.c Own_Above_Threat_stub.c Inhibit_Biased_Climb_stub.c initialize.c Own_Below_Threat_stub.c"
TEST_FILE="test_Non_Crossing_Biased_Descend.c"
