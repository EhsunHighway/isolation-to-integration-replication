...
SOURCE_FILE="tcas.c"
DRIVER_FILE="test_alt_sep_test.c"
REQUIRED_FILES="ALIM.c Inhibit_Biased_Climb.c Non_Crossing_Biased_Climb.c Non_Crossing_Biased_Descend.c Own_Above_Threat.c Own_Below_Threat.c alt_sep_test.c initialize.c"
INCLUDE_FOLDER="."
TARGET_FUNCTION="alt_sep_test"
