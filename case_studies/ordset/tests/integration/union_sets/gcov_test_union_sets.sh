...
TEST_EXECUTABLE="test_union_sets"
SOURCE_FILES="union_sets.c init_set_array.c def_set_size.c malloc_failure.c add_element.c is_over_flow.c contains_number.c bin_search.c make_a_free_slot.c resize_array.c"
TEST_FILE="test_union_sets.c"
