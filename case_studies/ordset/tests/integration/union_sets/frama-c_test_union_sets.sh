...
SOURCE_FILE="union_sets.c"
DRIVER_FILE="test_union_sets.c"
REQUIRED_FILES="add_element.c bin_search.c contains_number.c def_set_size.c free_memory.c init_set_array.c is_over_flow.c make_a_free_slot.c malloc_failure.c resize_array.c"
INCLUDE_FOLDER="."
TARGET_FUNCTION="union_sets"
