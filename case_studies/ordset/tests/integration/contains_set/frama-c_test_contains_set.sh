...
SOURCE_FILE="contains_set.c"
DRIVER_FILE="test_contains_set.c"
REQUIRED_FILES="bin_search.c def_set_size.c element_at.c free_memory.c init_set_array.c remove_element.c"
INCLUDE_FOLDER="."
TARGET_FUNCTION="contains_set"
