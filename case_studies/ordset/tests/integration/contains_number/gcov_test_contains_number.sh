...
TEST_EXECUTABLE="test_contains_number"
SOURCE_FILES="bin_search.c free_memory.c init_set_array.c def_set_size.c contains_number.c"
TEST_FILE="test_contains_number.c"
...
mkdir -p $OUTPUT_DIR
gcovr --root . --html --html-details --exclude 'test_contains_number.c' -o $OUTPUT_DIR/coverage_report.html
