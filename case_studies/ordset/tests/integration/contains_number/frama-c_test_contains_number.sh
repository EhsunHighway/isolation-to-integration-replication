...
SOURCE_FILE="contains_number.c"
DRIVER_FILE="test_contains_number.c"
REQUIRED_FILES="bin_search.c def_set_size.c free_memory.c init_set_array.c"
INCLUDE_FOLDER="."
TARGET_FUNCTION="contains_number"
