...
SOURCE_FILE="are_equals.c"
DRIVER_FILE="test_are_equals.c"
REQUIRED_FILES="def_set_size.c element_at_stub.c init_set_array.c is_empty_stub.c"
INCLUDE_FOLDER="."
TARGET_FUNCTION="are_equals"
