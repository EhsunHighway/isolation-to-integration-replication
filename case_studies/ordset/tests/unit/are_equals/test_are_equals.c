...
void test_1() {
    ...
    int preset_values[] = {1,1,2, 2,3, 3,7, 7};
    set_element_at_results(preset_values,8);
...
void test_3() {
    ...
    bool return_values[] = {true, true};
    set_is_empty_return_values(return_values, 2);

    test_are_equals(&set3, &c_set3, 0);  // Same size and empty
}
...
void test_4() {
    ...
    int preset_values[] = {1, 4, 2, 5, 3, 6, 7, 8};
    set_element_at_results(preset_values, 8);
...
void test_5() {
    ...
    ord_set c_set5;
    int c_elements5[] = {};
    init_set_array(&c_set5, c_elements5, 0);

    bool return_values[] = {true, false};
    set_is_empty_return_values(return_values, 2);

    test_are_equals(&set5, &c_set5, 0);
}
