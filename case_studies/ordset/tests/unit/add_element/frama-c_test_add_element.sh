...
SOURCE_FILE="add_element.c"
DRIVER_FILE="test_add_element.c"
REQUIRED_FILES="bin_search_stub.c contains_number_stub.c def_set_size.c init_set_array.c is_over_flow.c make_a_free_slot_stub.c resize_array_stub.c"
INCLUDE_FOLDER="."
TARGET_FUNCTION="add_element"
