...
TEST_EXECUTABLE="test_add_element"
SOURCE_FILES="add_element.c bin_search_stub.c contains_number_stub.c def_set_size.c make_a_free_slot_stub.c resize_array_stub.c is_over_flow.c init_set_array.c"
TEST_FILE="test_add_element.c"
