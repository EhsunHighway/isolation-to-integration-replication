...
SOURCE_FILE="resize_array.c"
DRIVER_FILE="test_resize_array.c"
REQUIRED_FILES="def_set_size.c free_memory.c init_set_array.c ord_set.c realloc_failure.c"
INCLUDE_FOLDER="."
TARGET_FUNCTION="resize_array"
