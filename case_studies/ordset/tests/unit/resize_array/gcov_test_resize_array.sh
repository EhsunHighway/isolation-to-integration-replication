...
TEST_EXECUTABLE="test_resize_array"
SOURCE_FILES="def_set_size.c free_memory.c init_set_array.c ord_set.c realloc_failure.c resize_array.c"
TEST_FILE="test_resize_array.c"
