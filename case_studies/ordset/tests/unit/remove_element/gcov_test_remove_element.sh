...
TEST_EXECUTABLE="test_remove_element"
SOURCE_FILES="remove_element.c bin_search_stub.c free_memory.c init_set_array.c def_set_size.c"
TEST_FILE="test_remove_element.c"
