...
SOURCE_FILE="remove_element.c"
DRIVER_FILE="test_remove_element.c"
REQUIRED_FILES="bin_search_stub.c def_set_size.c free_memory.c init_set_array.c"
INCLUDE_FOLDER="."
TARGET_FUNCTION="remove_element"
