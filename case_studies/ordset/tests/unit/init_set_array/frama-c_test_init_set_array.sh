...
SOURCE_FILE="init_set_array.c"
DRIVER_FILE="test_init_set_array.c"
REQUIRED_FILES="def_set_size_stub.c free_memory.c malloc_failure.c"
INCLUDE_FOLDER="."
TARGET_FUNCTION="init_set_array"
