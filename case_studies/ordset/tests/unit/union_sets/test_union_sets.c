...
void test_1() {
    ...
    set_with_added_element(expected_elements1, 5);  // Prepare the stub with expected results
...
void test_2() {
    ...
    int expected_elements2[] = {1, 2, 3, 7, 4, 5, 6};
    init_set_array(&expected_set2, expected_elements2, 7);

    set_with_added_element(expected_elements2, 6);  // Prepare the stub with expected results
