...
SOURCE_FILE="poly1305_get_tag.c"
DRIVER_FILE="test_poly1305_get_tag.c"
REQUIRED_FILES="U32TO8.c U8TO32.c poly1305_blocks.c poly1305_finish.c poly1305_init.c poly1305_update.c"
INCLUDE_FOLDER="."
TARGET_FUNCTION="poly1305_get_tag"
