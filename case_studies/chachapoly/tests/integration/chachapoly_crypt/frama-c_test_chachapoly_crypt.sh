...
SOURCE_FILE="chachapoly_crypt.c"
DRIVER_FILE="test_chachapoly_crypt.c"
REQUIRED_FILES="U32TO8.c U8TO32.c chacha_encrypt_bytes.c chacha_ivsetup.c chacha_keysetup.c chachapoly_init.c memcmp_eq.c poly1305_blocks.c poly1305_finish.c poly1305_get_tag.c poly1305_init.c poly1305_update.c"
INCLUDE_FOLDER="."
TARGET_FUNCTION="chachapoly_crypt"
