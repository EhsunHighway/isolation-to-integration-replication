...
void test_2() {
    ...
    set_the_block(6496736,41414,46047382,62667188,1274416);

    unsigned char mac2[16];

    unsigned char set_p2[4][4] = {
            { 164, 29, 40, 50 },
            { 184, 69, 80, 90 },
            { 224, 109, 120, 130 },
            { 8, 150, 160, 170 }
    ...
    set_U32T08(set_p2);
    unsigned char expected_mac2[16] = {164, 29, 40, 50, 184, 69, 80, 90, 224, 109, 120, 130, 8, 150, 160, 170};
