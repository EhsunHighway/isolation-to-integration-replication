...
TEST_EXECUTABLE="test_poly1305_finish"
SOURCE_FILES="poly1305_finish.c poly1305_blocks_stub.c poly1305_init.c U8TO32.c U32TO8_stub.c"
TEST_FILE="test_poly1305_finish.c"
