...
SOURCE_FILE="poly1305_finish.c"
DRIVER_FILE="test_poly1305_finish.c"
REQUIRED_FILES="U32TO8_stub.c U8TO32.c poly1305_blocks_stub.c poly1305_init.c"
INCLUDE_FOLDER="."
TARGET_FUNCTION="poly1305_finish"
