...
TEST_EXECUTABLE="test_U8TO32"
SOURCE_FILES="U8TO32.c"
TEST_FILE="test_U8TO32.c"
...
mkdir -p $OUTPUT_DIR
gcovr --root . --html --html-details --exclude "$TEST_FILE" --filter U8TO32.c -o $OUTPUT_DIR/coverage_report.html
