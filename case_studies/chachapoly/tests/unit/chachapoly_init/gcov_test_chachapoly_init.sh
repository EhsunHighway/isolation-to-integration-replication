...
TEST_EXECUTABLE="test_chachapoly_init"
SOURCE_FILES="chachapoly_init.c chacha_keysetup_stub.c"
TEST_FILE="test_chachapoly_init.c"
...
mkdir -p $OUTPUT_DIR
gcovr --root . --html --html-details --exclude "$TEST_FILE" --filter chachapoly_init.c -o $OUTPUT_DIR/coverage_report.html
