...
TEST_EXECUTABLE="test_chacha_keysetup"
SOURCE_FILES="chacha_keysetup.c"
TEST_FILE="test_chacha_keysetup.c"
...
mkdir -p $OUTPUT_DIR
gcovr --root . --html --html-details --exclude "$TEST_FILE" --filter chacha_keysetup.c -o $OUTPUT_DIR/coverage_report.html
