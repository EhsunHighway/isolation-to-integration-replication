...
TEST_EXECUTABLE="test_chacha_ivsetup"
SOURCE_FILES="chacha_ivsetup.c"
TEST_FILE="test_chacha_ivsetup.c"
...
mkdir -p $OUTPUT_DIR
gcovr --root . --html --html-details --exclude "$TEST_FILE" --filter chacha_ivsetup.c -o $OUTPUT_DIR/coverage_report.html
