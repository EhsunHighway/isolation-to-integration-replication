...
SOURCE_FILE="poly1305_update.c"
DRIVER_FILE="test_poly1305_update.c"
REQUIRED_FILES="U8TO32.c poly1305_blocks_stub.c poly1305_init.c"
INCLUDE_FOLDER="."
TARGET_FUNCTION="poly1305_update"
