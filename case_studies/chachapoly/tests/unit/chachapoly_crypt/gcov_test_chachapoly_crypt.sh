...
SOURCE_FILES="chachapoly_crypt.c chachapoly_init.c chacha_keysetup.c memcmp_eq_stub.c poly1305_get_tag_stub.c chacha_ivsetup_stub.c chacha_encrypt_bytes_stub.c"
...
gcovr --root . --html --html-details \
    --exclude "$TEST_FILE" \
    --exclude ".*chachapoly_init.c" \
    --exclude ".*chacha_keysetup.c" \
